                                    ...
                                    <tr key={producto.id}>
                                        ...
                                        <td>
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" checked={producto.comprado}/>
                                            </div>
                                        </td>
                                        <td>
                                            <button className="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#modalProducto" onClick={() => openModal(2,producto)}>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <Campo id="precio" iconName="fa-solid fa-dollar-sign" inputType="number" placeholder="Precio" onChange={(e)=>setPrecio(e.target.value)} value={precio}></Campo>
                                <div>
                                    <input className="form-check-input" id="comprado" type="checkbox" onChange={() => setComprado((state) => !state)} checked={comprado}/>
                                    <label className="form-check-label" htmlFor="comprado">Comprado</label>
                                </div>
